...
<cu-custom bgColor="bg-gradual-pink" :isBack="true">
		...
		<view class="page-section swiper">
			<view>
				<video id="myVideo" :src="detail.url"
					@error="videoErrorCallback" width="100%" height="400px"  enable-danmu
			...
			<view class="main_i">
				...
				<view style="display: flex;padding: 10px 0;  flex-wrap:wrap">
					<view :class="'item_'+t_index" v-for="(tagitem,t_index) in detail.hot_tags.split(',')" :key="t_index">
						{{tagitem}}
					</view>
				</view>
